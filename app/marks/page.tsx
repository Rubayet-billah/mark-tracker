                        ...
                        <table className="w-full text-sm text-left border-collapse">
                            <thead className="bg-gray-100 border-b border-gray-200 print:bg-gray-50">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 font-bold text-gray-700 text-center print:border print:border-gray-300">Attendance</th>
                                    <th className="px-4 py-3 font-bold text-gray-700 text-center print:border print:border-gray-300">Assignment</th>
                                    <th className="px-4 py-3 font-bold text-gray-700 text-center print:border print:border-gray-300">Midterm</th>
                                ...
                                {marksData.length > 0 ? (
                                    marksData.map((mark: any) => (
                                        <tr key={mark._id.toString()} className="hover:bg-gray-50 transition">
                                            ...
                                            <td className="px-4 py-3 text-center text-gray-600 print:border print:border-gray-300">{mark.marks?.attendance ?? '0'}</td>
                                            <td className="px-4 py-3 text-center text-gray-600 print:border print:border-gray-300">{mark.marks?.assignment ?? '0'}</td>
                                            <td className="px-4 py-3 text-center text-gray-600 print:border print:border-gray-300">{mark.marks?.midterm ?? '0'}</td>
